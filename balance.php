...
if(!empty($_POST['amount'])) {
  if($_POST['amount'] > 0) {
    ...
    $alert = [
      'message' => 'You have added Rs' . $_POST['amount'],
      'type' => 'success',
    ];
  } else {
    $alert = [
          ...
          <div class="col-lg-6">
            ...
            <? endif; ?>
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Refill Balance</h1>
              </div>
              <form class="user" method="post" action="balance.php">
                <div class="form-group">
                  <input name="amount" type="number" class="form-control form-control-user" id="amount" placeholder="Enter amount" required>
                </div>
